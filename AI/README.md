...
| 阶段/领域 | 论文名称 | 发表年份 | 核心贡献/地位 |
| :--- | :--- | :--- | :--- |
| **🧠 早期基础与理论** | Computing Machinery and Intelligence | 1950 | 提出**图灵测试**，定义了机器智能。 |
| | A Logical Calculus of the Ideas Immanent in Nervous Activity | 1943 | 提出**M-P神经元模型**，是神经网络的基础。 |
| | The Perceptron: A Probabilistic Model for Information Storage and Organization in the Brain | 1958 | 提出**感知机模型**，掀起了第一次神经网络研究热潮。 |
...
| | Improving Language Understanding by Generative Pre-Training (**GPT-1**) | 2018 | 提出**GPT系列**的初代模型，开创了生成式预训练路径。 |
| | Language Models are Few-Shot Learners (**GPT-3**) | 2020 | 提出拥有1750亿参数的**GPT-3**，展示了**大模型的少样本学习能力**。 |
| | Training language models to follow instructions with human feedback (**InstructGPT**) | 2022 | 提出基于人类反馈的强化学习（RLHF），让模型输出与人类意图对齐。 |
| | LLaMA: Open and Efficient Foundation Language Models | 2023 | Meta发布的开源高效大模型系列，推动了开源社区发展。 |
